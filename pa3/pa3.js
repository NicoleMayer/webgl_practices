...
// !! ref: https://blog.csdn.net/wangdingqiaoit/article/details/52506893
...
function setupCubeMap() {
	...
	for (var i = 0; i < 6; i++) {
		...
		cubeImage[i].onload = function () {
			...
			if (i == 6) {
				for (var j = 0; j < 6; j++) {
					gl.texImage2D(targets[j], 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, cubeImage[j]);
